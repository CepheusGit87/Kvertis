...
| Microsoft.Graphics.Win2D | 1.4.0 | Microsoft Software License Terms für das NuGet-Paket (Quellcode MIT) | GPU-Zeichenschicht über Direct2D für Galaxie, Pixelwirbel, weißes Loch und Übergänge (ADR-018); keine Bild- oder Videodekodierung | NuGet + native (`Microsoft.Graphics.Canvas.dll` für x64, x86, arm64; von Microsoft signiert) | geprüft, geplant (Prüfbericht unten, Lizenztexte in `third_party/_geplant/Win2D/`) |
