...
- Schritt 2, Wahl der Dateiart links: je Art ein minimalistisches kleines Universum mit Ring und flachem Linien-Symbol, kein 3D, keine Planeten je Datei. Soll professionell und dezent wirken: feine Linien, Farbe nur bei der gewählten Art, kein Glühen, Bahn nach vorn kräftiger. Drei Varianten in `artwahl-dezent.html`: K1 gleitendes Licht, K2 feine Skala, K3 Bewegung nur beim Wechsel. Vorschlag: K3, optional mit dem Licht aus K1. Zwischenstände: `artwahl-flach.html` (J1–J4, zu laut), `artwahl-bahnen.html` (G1–G4). Verworfen: 3D-Symbole.
