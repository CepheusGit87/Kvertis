...
- Schritt 2: „Zoom-Wege“ aus `ziel-konzepte.html` bleibt die Grundlage, mit links, Mitte und rechts aus Variante 1 „Karten und Dock“ in `zoom-wege-neu.html`. `zoom-einstellungen.html` und `ziel-einfach.html` sind verworfen. Offen sind noch zwei Punkte, beide in `artwahl-ausgabe.html`. Erstens die Wahl der Dateiart: A1 Fortschritt unten, A2 zweiter Faden oben, A3 senkrecht links, A4 Planeten im Bogen, A5 im Titel blättern. Zweitens die Ausgabe-Einstellungen rechts mit Zielgröße je Datei und „Was sich ändert“: B1 Umschalter Qualität/Zielgröße, B2 Größenleiste mit Ampel, B3 Liste, B4 Was vom Original bleibt. Vorschlag: A2, dazu B1 mit der Leiste aus B2 und den Balken aus B4 als Zusammenfassung. Bis zur Wahl bleibt Schritt 2 im Mischentwurf, wie er ist.
