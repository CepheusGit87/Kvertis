...
| Schritt 2 | „Zoom-Wege“ mit links, Mitte und rechts aus „Karten und Dock“: links die Dateien als Karten mit Vorschau und „Alle gleich / Jede einzeln“, Mitte Bahn, Loch und Wege je Datei, rechts die Ziele mit Größe. Dateiart wählt man über die senkrechte Leiste am linken Rand (A3: Symbol, Anzahl, gewähltes Ziel). Ausgabe-Einstellungen rechts unter den Zielen (D1 mit farbigem Griff aus D2): oben die Note von 0 bis 100 im Ring mit Wort, Größe und Säulen je Merkmal; darunter die Größenleiste von Rot bis Grün mit Marken wie „E-Mail“, ihr Griff ist ein farbiger Ring ohne Zahl (Grün, Gelb, Rot wie die Note); unten zwei Zonen, anfangs zu: „Alle Einstellungen“ (Zielgröße genau, Qualität, Bildgröße, Privatsphäre usw. nach Bereichen) und „Was sich ändert“ (Balken je Merkmal und Hinweise). | `note-leiste-zonen.html` (Gewählt), `artwahl-ausgabe.html` (A3) |
