...
- Schritt 2, Wahl der Dateiart links: je Art ein minimalistisches kleines Universum mit Ring, die flachen Linien-Symbole in der Mitte, kein 3D, keine Planeten je Datei. Die Bahn ist zweigeteilt (hintere Hälfte hinter, vordere vor dem Symbol). Vier Animationen in `artwahl-flach.html`: J1 Lichtpunkt, J2 Lichtbogen, J3 Schweben mit Wellen, J4 Zeichnen und Glanz. Vorschlag: J2, dazu das Zeichnen aus J4 beim Wechsel. Verworfen: 3D-Symbole (H1–H4, I1–I3, Seiten entfernt), `artwahl-bahnen.html` (G1–G4).
